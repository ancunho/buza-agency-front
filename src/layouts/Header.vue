                            ...
                            <div class="flex">
                                ...
                                <div
                                    ...
                                    <select id="locale-language" name="language" 
                                        v-model="currentLocale" 
                                        @change="changeLocale" 
                                        class="flex items-center rounded-md bg-gray-900 text-white border-transparent py-0.5 pl-2 pr-5 text-sm font-medium text-gray-700 focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-800">
                                        <option value="ko">한국어</option>
                                        <option value="en">English</option>
                                        <option value="zh">中文</option>
                                    </select>
